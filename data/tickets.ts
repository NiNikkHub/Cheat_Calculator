...
const practices: Record<string, PracticeAnswer> = {
  ...
  expertMeanVariance: {
    task: "Даны экспертные оценки: 1, 4, 0, 2, 1, 3, 0, 0, 2, 3, 4, 2, 1, 0, 3, 2, 4, 0, 2, 3, 1, 3, 2. Представить данные в порядке неубывания в виде дискретного вариационного ряда. Определить среднее значение признака и его дисперсию.",
    steps: [
      "Всего в ряду 23 оценки. Дискретный вариационный ряд: xᵢ = 0, 1, 2, 3, 4; частоты nᵢ = 5, 4, 6, 5, 3.",
      "Проверка: 5 + 4 + 6 + 5 + 3 = 23. Сумма Σ(xᵢnᵢ) = 0·5 + 1·4 + 2·6 + 3·5 + 4·3 = 43.",
      "Сумма квадратов: Σ(xᵢ²nᵢ) = 0²·5 + 1²·4 + 2²·6 + 3²·5 + 4²·3 = 121.",
      "Выборочное среднее: x̄ = 43/23 ≈ 1,8696. Средний квадрат: x̄² = 121/23 ≈ 5,2609.",
      "Выборочная дисперсия: Dв = 121/23 − (43/23)² ≈ 1,7656. Исправленная дисперсия: s² = Dв·23/22 ≈ 1,8458.",
    ],
    shortCalculation: "n=23; x̄=43/23≈1,8696; Dв=121/23−(43/23)²≈1,7656; s²=Dв·23/22≈1,8458.",
    answer: "x̄ ≈ 1,8696; Dв ≈ 1,7656; исправленная дисперсия s² ≈ 1,8458.",
  },
  saltsFull: {
